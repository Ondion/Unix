...
/*
  ...
  Parâmetros:
  - Um objeto. Exemplos: { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'água': 3.9, 'cerveja': 6.9} }.
  Comportamento:

  const meuRestaurante = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'água': 3.9, 'cerveja': 6.9} }).

  meuRestaurante.fetchMenu() // Retorno: { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'água': 3.9, 'cerveja': 6.9} }
...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // --------------------------------------------------------------------------------------
    objetoRetornado.order("guarana")
    expect(objetoRetornado.consumption).toEqual(["guarana"])
    ...
    expect(objetoRetornado.consumption).toEqual(["guarana", "coxinha", "agua", "sopa"])
    ...
    objetoRetornado.order("agua");
    objetoRetornado.order("sopa");
    expect(objetoRetornado.consumption).toEqual(["guarana", "coxinha", "agua", "sopa", "coxinha", "agua", "sopa"])
    ...
    // --------------------------------------------------------------------------------------
    expect(objetoRetornado.pay()).toBeCloseTo(22.55)
